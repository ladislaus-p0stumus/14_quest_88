  ...
  Mesh processMesh(aiMesh *mesh, const aiScene *scene) {
    ...
    /*
        ...
        if (diffuseMaps.empty()) {
          Texture diftex;
          diftex.id =
              TextureFromFile("diffuse.jpg", this->directory, gammaCorrection);
          diftex.type = "texture_diffuse";
          diftex.path = "diffuse.jpg";
          textures.push_back(diftex);
        }
        if (specularMaps.empty()) {
          Texture spectex;
          spectex.id =
              TextureFromFile("specular.jpg", this->directory, gammaCorrection);
          spectex.type = "texture_specular";
          spectex.path = "specular.jpg";
          textures.push_back(spectex);
        }
        if (normalMaps.empty()) {
          Texture normtex;
          normtex.id =
              TextureFromFile("normal.png", this->directory, gammaCorrection);
          normtex.type = "texture_normal";
          normtex.path = "normal.png";
          textures.push_back(normtex);
        }
    */
...
unsigned int TextureFromFile(const char *path, const string &directory,
  ...
  if (filename == "11446785469_0.png") {
    filename = "1611446785469_0.png";
  }

  if (filename == "use.jpg") {
    filename = "diffuse.jpg";
  } /*
   if (filename == "ffuse.jpg") {
     filename = "diffuse.jpg";
   }
   if (filename == "ular.jpg") {
